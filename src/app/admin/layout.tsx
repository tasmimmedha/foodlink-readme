...
const NAV_ITEMS = [
  ...
  { href: "/admin/foods", label: "Food Items", icon: Package },
          ...
          >
            ...
            <div className="flex flex-col min-w-[150px]">
              <div className="flex items-center justify-between text-xs font-semibold mb-1">
                ...
                <span className="text-xs px-1.5 py-0 bg-emerald-500/10 text-emerald-600 rounded">
                  Active
                </span>
              </div>
              ...
              <DropdownMenuLabel>
                <div className="flex items-center gap-3 py-2">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">{user?.email ?? "admin@foodflow.app"}</p>
                  </div>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />

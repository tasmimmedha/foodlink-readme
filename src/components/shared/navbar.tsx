    ...
    <header className="sticky top-0 z-30 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
      <div className="container flex h-16 items-center justify-between px-4 lg:px-6">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-bold bg-gradient-to-r from-[#22c55e] to-[#16a34a] bg-clip-text text-transparent">
            FoodFlow
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="icon" className="relative">
            ...
            <span className="absolute top-1 right-1 h-2 w-2 bg-[#22c55e] rounded-full" />
          </Button>
